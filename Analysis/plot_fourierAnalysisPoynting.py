...
plt.subplot(231)
axp = plt.imshow(Sx, aspect='equal', origin='lower', cmap = 'jet', extent=(0,lengthOfSimulationBoxInX,0,lengthOfSimulationBoxInY), vmin=-SxMax, vmax=SxMax)
...
plt.subplot(232)
axp = plt.imshow(Sy, aspect='equal', origin='lower', cmap = 'jet', extent=(0,lengthOfSimulationBoxInX,0,lengthOfSimulationBoxInY), vmin=-SyMax, vmax=SyMax)
plt.colorbar(format='%.0e')
plt.xlabel('X')
plt.ylabel('Y')
plt.title('$S_y$')
...
plt.subplot(233)
axp = plt.imshow(Sz, aspect='equal', origin='lower', cmap = 'jet', extent=(0,lengthOfSimulationBoxInX,0,lengthOfSimulationBoxInY), vmin=-SzMax, vmax=SzMax)
plt.colorbar(format='%.0e')
plt.xlabel('X')
plt.ylabel('Y')
plt.title('$S_z$')
