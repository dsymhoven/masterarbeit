...
LWfield = np.genfromtxt('E_fields/E_field0.txt')
ExtField = np.genfromtxt('E_extern/E_extern0.txt')
...
# plot fields
plt.imshow(LWfield, aspect='auto', origin='lower', cmap = 'jet', extent=(0,lengthOfSimulationBoxInX,0,lengthOfSimulationBoxInY), vmin=0, vmax=0.1)
plt.imshow(ExtField, aspect='auto', origin='lower', cmap = 'jet', extent=(0,lengthOfSimulationBoxInX,0,lengthOfSimulationBoxInY), vmin=0, vmax=0.1)
plt.colorbar()
# set labels
plt.xlabel("X")
plt.ylabel("Y")
