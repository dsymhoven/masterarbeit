...
\begin{multline}
D_x\Bigr|_{(i,j+\frac{1}{2},k)}^{n+1} = \left(\frac{2\epsilon_0\kappa_y - \sigma_y h}{2\epsilon_0\kappa_y + \sigma_y h}\right) D_x\Bigr|_{i+\frac{1}{2},j,k}^{n} + \left(\frac{2\epsilon_0 h}{2\epsilon_0\kappa_y + \sigma_y h}\right) \\
