...
\end{bmatrix},
\eeq
with $a, b, c \in \mathbb{R}$. Considering anisotropy the Fresnel Equations change, For example for an incident wave traveling along z-axis, the Fresnel Equations read
\begin{figure}[t]
	\centering
...
\eeq
We now need to find conditions for $a,b,c \in \mathbb{R}$ to make the Fresnel equations \eqref{eqn: Fresnel} independent of angle and simultaneously let the reflection parameter vanish. \\
