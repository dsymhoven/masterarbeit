...
\begin{figure}[H]
	...
	\caption[External laser pulse at $t = 700$]{External laser pulse at $t = 700$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: external Pulse}
\end{figure}
\noindent
The idea is to slowly increase $\gamma$ while maintaining a small angle between the particle and the incoming external laser pulse. With increasing $\gamma$ the direction of the radiated Linard Wiéchert field should become more more directed. Similarly, the radiation  frequency should increase as well. Using increments of $\Delta \gamma = 0.1$ we increased from $\gamma = 1.0$ up to $\gamma = 1.5$. To analyze the radiation direction and radiation frequency we made a Fourier Analysis of the electric field components $\vec{E}$ and of the components of the Poynting vector $\vec{S}$. Figures \ref{fig: plain result gamma1.0} - \ref{fig: plain result gamma1.5} show the plain simulation results, both with and without the near field region of the particle.
...
In the next step the electric field components $\vec{E}$ as well as the Poynting vector $\vec{S}$ are 2D Fourier analyzed. The results are shown in figures \ref{fig: E fourier gamma1.0} - \ref{fig: S fourier gamma1.5}
% fourier gamma = 1.0
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.1_0.01_gamma1.0/fourierAnalysis2D.png} 
	\caption[Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.0$]{Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.0$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: E fourier gamma1.0}
\end{figure}
\noindent
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.1_0.01_gamma1.0/fourierAnalysisPoynting2D.png} 
	\caption[Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.0$]{Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.0$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: S fourier gamma1.0}
\end{figure}
\noindent
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.46_0.01_gamma1.1/fourierAnalysis2D.png} 
	\caption[Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.1$]{Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.1$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: E fourier gamma1.1}
\end{figure}
\noindent
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.46_0.01_gamma1.1/fourierAnalysisPoynting2D.png} 
	\caption[Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.1$]{Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.1$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: S fourier gamma1.1}
\end{figure}
\noindent
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.67_0.01_gamma1.2/fourierAnalysis2D.png} 
	\caption[Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.2$]{Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.2$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: E fourier gamma1.2}
\end{figure}
\noindent
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.67_0.01_gamma1.2/fourierAnalysisPoynting2D.png} 
	\caption[Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.2$]{Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.2$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: S fourier gamma1.2}
\end{figure}
\noindent
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.84_0.01_gamma1.3/fourierAnalysis2D.png} 
	\caption[Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.3$]{Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.3$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: E fourier gamma1.3}
\end{figure}
\noindent
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.84_0.01_gamma1.3/fourierAnalysisPoynting2D.png} 
	\caption[Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.3$]{Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.3$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: S fourier gamma1.3}
\end{figure}
\noindent
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.98_0.01_gamma1.4/fourierAnalysis2D.png} 
	\caption[Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.4$]{Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.4$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: E fourier gamma1.4}
\end{figure}
\noindent
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/0.98_0.01_gamma1.4/fourierAnalysisPoynting2D.png} 
	\caption[Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.4$]{Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.4$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: S fourier gamma1.4}
\end{figure}
\noindent
...
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/1.12_0.01_gamma1.5/fourierAnalysis2D.png} 
	\caption[Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.5$]{Fourier analysis of the electric field components of $\vec{E}$ at $\gamma = 1.5$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: E fourier gamma1.5}
\end{figure}
\noindent
\begin{figure}[H]
	\centering
		\includegraphics[width=0.8\textwidth]{Pictures/results/1.12_0.01_gamma1.5/fourierAnalysisPoynting2D.png} 
	\caption[Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.5$]{Fourier analysis of the components of the Poynting vector $\vec{S}$ at $\gamma = 1.5$. The colorbar shows the value of $|\vec{E}|^2$. $\vec{E}$ and $c\vec{B}$ are in units of $4\pi\epsilon_0m_e^2c^4/e^3 = 1.77 \cdot 10^{20} \si{\volt\per\meter}$, length in units of $e^2 / (4\pi\epsilon_0m_ec^2) = 2.82 \cdot 10^{-15}\si{\meter}$ and times in units of $e^2 / (4\pi\epsilon_0m_ec^3) = 9.40 \cdot 10^{-24}\si{\second}$.}
	\label{fig: S fourier gamma1.5}
\end{figure}
\noindent
