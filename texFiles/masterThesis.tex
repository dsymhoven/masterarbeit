...
\Longleftrightarrow \omega h &= 2\arcsin\left(\frac{\Delta t}{\Delta x} \sin\left(\frac{\tilde{k}_x \Delta x}{2}\right)\right),
\eal
\eeq
which is quite more complicated than the analytic dispersion relation
\beq
\omega = k
\eeq
