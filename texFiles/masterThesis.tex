...
\newline
We now explain how this works out in code. Figure \ref{fig: CodeRoutineBoxes} shows three boxes, two of which are near field boxes and one is a far field box. For reasons of clarity we only show the grid points along the edges.
\begin{figure}[H]
	\centering
